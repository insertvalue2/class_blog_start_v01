...
// 2. 중복 로딩 방지 initState는 단 한번만 호출 됨
// 3. 타이밍 제어 : 안전한 provider 에 접근이 가능하도록 설계 가능
...
class _PostDetailBodyState extends ConsumerState<PostDetailBody> {
  ...
  void initState() {
    ...
    /// addPostFrameCallback 을 사용하는 이유
    // 1. 안정성 : build 메서드 완료 수 실행 보장
